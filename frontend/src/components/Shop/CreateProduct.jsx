      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Digite as tags do seu produto..."
          />
        </div>
        ...
        <div>
          <label className="pb-2">
            Preço (Com disconto) <span className="text-red-500">*</span>
          </label>
          <input
            type="number"
            name="preço"
            ...
            placeholder="Digite o preço com o desconto..."
          />
        </div>
        ...
        <div>
          <label className="pb-2">
            Estoque do Produto <span className="text-red-500">*</span>
          </label>
          <input
            type="number"
            name="price"
