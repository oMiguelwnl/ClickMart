...
const WithdrawMoney = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      ...
      .then(() => {
        toast.success("Método de saque adicionado com sucesso!");
        dispatch(loadSeller());
        setBankInfo({
          bankName: "",
          bankCountry: "",
  ...
  const deleteHandler = async () => {
    await axios
      ...
      .then(() => {
        toast.success("Método de saque excluído com sucesso!");
        dispatch(loadSeller());
      });
  };
  ...
  const withdrawHandler = async () => {
    if (withdrawAmount < 50 || withdrawAmount > availableBalance) {
      toast.error("Você não pode sacar este valor!");
    } else {
                ...
                <form onSubmit={handleSubmit}>
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Insira o nome do seu banco!"
                  ...
                  <div className="pt-2">
                    ...
                    <input
                      ...
                      placeholder="Insira o código Swift do seu banco!"
                      className={`${styles.input} mt-2`}
                    />
                  </div>
                  <div className="pt-2">
                    ...
                    <input
                      ...
                      required
                      placeholder="Insira o número da sua conta bancária!"
                      className={`${styles.input} mt-2`}
                    />
                  </div>
                  <div className="pt-2">
                  ...
                  <div>
                    <div className="800px:flex w-full justify-between items-center">
                      <div className="800px:w-[50%]">
                        ...
                        <h5>
                          Nome do Banco: {seller?.withdrawMethod.bankName}
                        </h5>
                      </div>
                      <div className="800px:w-[50%]">
                        <AiOutlineDelete
                    ...
                    <br />
                    <h4>Saldo disponível: R${availableBalance}</h4>
                    <br />
